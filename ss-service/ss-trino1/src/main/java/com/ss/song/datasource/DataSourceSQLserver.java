...
/**
 * jdbc:sqlserver://192.168.3.48:1433;DatabaseName=master
 */
public class DataSourceSQLserver extends DataSourceRelation {

    public static final String TYPE = "SQLServer".toLowerCase();

    public DataSourceSQLserver(DataSourceParam param) {
        super(param);
    ...
    private static final Pattern p = Pattern.compile("^jdbc:sqlserver://(.*):(\\d+);DatabaseName=(.*)$");
    @Override
